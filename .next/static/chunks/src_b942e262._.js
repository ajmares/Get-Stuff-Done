...
function TodayView(param) {
    ...
    const nextBestActions = tasks.filter((task)=>!task.isMustDo && task.status !== 'DONE').sort((a, b)=>{
        // Sort by priority (P0 first), then due date, then creation date
        const priorityOrder = {
            P0: 0,
            P1: 1,
            P2: 2,
...
//# sourceMappingURL=src_b942e262._.js.map