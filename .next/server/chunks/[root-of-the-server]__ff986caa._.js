...
async function POST(request) {
    try {
        ...
        if (body.projectName && !projectId) {
            ...
            const existingProject = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.findFirst({
                where: {
            ...
            if (existingProject) {
                ...
                const newProject = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.create({
                    data: {
                        name: body.projectName
                    }
                });
        ...
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].task.create({
            data: {
                title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff986caa._.js.map