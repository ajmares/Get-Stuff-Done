...
// Validate ../../src/app/api/focus-blocks/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/focus-blocks/[id]">> = Specific
  const handler = {} as typeof import("../../src/app/api/focus-blocks/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/focus-blocks/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/focus-blocks">> = Specific
  const handler = {} as typeof import("../../src/app/api/focus-blocks/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/weekly-focus/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/weekly-focus">> = Specific
  const handler = {} as typeof import("../../src/app/api/weekly-focus/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
